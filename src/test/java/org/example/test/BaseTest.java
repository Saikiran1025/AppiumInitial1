...
public class BaseTest extends GrowwUtils {
    protected Login loginPage;
    protected DashboardTab dashboardPage;
    protected ExploreTab explorePage;
    protected ProductPage productPage;
    protected PlaceOrder placeOrderPage;
    protected SIPs sipsPage;
    protected InvestmentDetails investmentDetailsPage;

    @BeforeMethod(alwaysRun = true)
    public void setUp() throws Exception {
        setup(); // Initialize driver from GrowwUtils
        initializePages();
    }

    private void initializePages() {
        loginPage = new Login(driver);
        dashboardPage = new DashboardTab(driver);
        explorePage = new ExploreTab(driver);
        productPage = new ProductPage(driver);
        placeOrderPage = new PlaceOrder(driver);
        sipsPage = new SIPs(driver);
        investmentDetailsPage = new InvestmentDetails(driver);
    }
...
//    }
    ...
    protected void navigateToMutualFunds() {
        clickMFTab();
    }

    protected void navigateToSIPs() {
        clickMFTab();
        clickSipTab();
    }
}
